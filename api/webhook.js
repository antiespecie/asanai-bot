...
async function generateYogaPlan(goal, lang) {
  ...
  const prompts = {
    en: `You are Asanai, an AI yoga coach. Create a yoga session for: ${focus}. Level: beginner.\n\nFormat exactly:\nTITLE: [name]\nDURATION: [X min]\nDESCRIPTION: [2 warm sentences]\nPOSES:\n1. [Pose] — [duration] — [benefit]\n2. [Pose] — [duration] — [benefit]\n3. [Pose] — [duration] — [benefit]\n4. [Pose] — [duration] — [benefit]\n5. [Pose] — [duration] — [benefit]\nTIP: [one practical tip]\n\nNo markdown, plain text only.`,
    es: `Eres Asanai, coach de yoga con IA. Crea una sesión para: ${focus}. Nivel: principiante.\n\nFormato exacto:\nTITULO: [nombre]\nDURACION: [X min]\nDESCRIPCION: [2 oraciones cálidas]\nPOSTURAS:\n1. [Postura] — [duración] — [beneficio]\n2. [Postura] — [duración] — [beneficio]\n3. [Postura] — [duración] — [beneficio]\n4. [Postura] — [duración] — [beneficio]\n5. [Postura] — [duración] — [beneficio]\nCONSEJO: [un consejo práctico]\n\nSin markdown, solo texto plano.`,
    pt: `Você é Asanai, coach de yoga com IA. Crie uma sessão para: ${focus}. Nível: iniciante.\n\nFormato exato:\nTITULO: [nome]\nDURACAO: [X min]\nDESCRICAO: [2 frases calorosas]\nPOSTURAS:\n1. [Postura] — [duração] — [benefício]\n2. [Postura] — [duração] — [benefício]\n3. [Postura] — [duração] — [benefício]\n4. [Postura] — [duração] — [benefício]\n5. [Postura] — [duração] — [benefício]\nDICA: [uma dica prática]\n\nSem markdown, apenas texto simples.`,
  };
